        ...
        if leftBlack <20:
            while leftBlack <20:
                ...
                if rightBlack >20 and leftBlack >20:
                    motorLeft.off()
                    motorRight.off()
        motorLeft.run_to_rel_pos(position_sp= -700, speed_sp = 300)
        motorRight.run_to_rel_pos(position_sp= -700, speed_sp = 300)
        motorLeft.wait_while('running')
        motorRight.wait_while('running')

    if move == 'r':
        motorLeft.run_to_rel_pos(position_sp= -210, speed_sp = 200)
        motorRight.run_to_rel_pos(position_sp= 210, speed_sp = 200)
        motorLeft.wait_while('running')
        motorRight.wait_while('running')
    if move == 'l':
        motorLeft.run_to_rel_pos(position_sp= 210, speed_sp = 200)
        ...
        motorRight.wait_while('running')
    if move == '180':
        motorLeft.run_to_rel_pos(position_sp= 420, speed_sp = 200)
        motorRight.run_to_rel_pos(position_sp= -420, speed_sp = 200)
        motorLeft.wait_while('running')
        motorRight.wait_while('running')
    if move =='fire':
...
#                 des+=1
#         if des>20:
#             face=move(now,PlaceList[PlaceList.index(now)-1],face)
...
#         around_gold=True
#         face=move(place,PlaceList[PlaceList.index(place)-1],face) 
...
#                 face=move(place,nbrs(place)[i],face)
#                 place=nbrs(place)[i]
#                 print('move to {}'.format(place))    #done
...
#                 face=move(place,vom_location,face)
#                 place=vom_location
#                 print('move to {}'.format(place))    #done
#                 stench=='killed'
#                 PlaceList.append(place)
...
#                 face=move(place,next_to_vom,face)
#                 place=next_to_vom
#                 PlaceList.append(place)
#                 print('kill wumpus at {}'.format(vom_location))    #done
#                 stench=='killed'
#                 face=move(place,vom_location,face)
#                 place=vom_location
#                 print('move to {}'.format(place))   #done
